...
[![Languages and Tools:](https://skillicons.dev/icons?i=js,react,vite,typescript,redux,html,css,bootstrap,java,c,cpp,mysql,py,tailwind,figma,git,github,replit,postman,docker,appwrite,pr,ps,xd,ai,flutter,clerk)]()
